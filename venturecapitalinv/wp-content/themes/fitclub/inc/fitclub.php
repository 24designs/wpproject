...
function fitclub_footer_copyright_info() {
  ...
  $default_footer_value = '<span class="copyright-text">' . sprintf( esc_html__( 'Copyright &copy; %1$s %2$s.', 'fitclub' ), date( 'Y' ), $site_link ).' '.sprintf( esc_html__( '%1$s', 'fitclub' ), $tg_link ) . '</span>';
