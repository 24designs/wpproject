...
<h5 class="class-title"><a title="<?php the_title_attribute(); ?>" alt="<?php the_title_attribute(); ?>"> <?php echo esc_html( get_the_title() ); ?></a></h5>

									<div class="class-content">
										<?php the_excerpt(); ?>
									</div>

									<a class="class-read-more" href="http://venturecapitalinv.esy.es/services/" title="<?php the_title_attribute(); ?>"> <?php esc_html_e( 'Learn More', 'fitclub' ) ?></a>
								</div>
							</div>
						<?php $count++;
						endwhile; ?>
...
$output .= '<a class="about-btn" href="http://venturecapitalinv.esy.es/about/">' . esc_html__( 'Read more', 'fitclub' ) . '</a>';
